...
export function MessageLog({ messages }: { messages: GroupedMessage[] }) {
  return (
    <div className="mt-2 h-96 overflow-y-auto rounded-md border border-gray-200 bg-gray-50 p-2 dark:border-zinc-800 dark:bg-zinc-900">
      {messages
